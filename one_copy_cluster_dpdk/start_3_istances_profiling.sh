...
$profile ./build/cluster_dpdk -c 0X11 -n 4 --proc-type=auto -- -n 3 -p 0 &
sleep 5
$profile ./build/cluster_dpdk -c 0X22 -n 4 --proc-type=auto -- -n 3 -p 1 &
sleep 2
$profile ./build/cluster_dpdk -c 0X44 -n 4 --proc-type=auto -- -n 3 -p 2 &
sleep 2
