...
#define STATS_PRINT_RATE (3500000000) 	// You print stats each STATS_PRINT_RATE clock cycles. On this machine is 3500000000, since clock is 3.7 Ghz. Use 140s for 5 min traces, 85s at 10Gbps
...
static int main_loop_consumer(__attribute__((unused)) void * arg){
	...
	FILE * measures = fopen ("measures.txt", "w");
